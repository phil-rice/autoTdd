...
public class StepCreatorBehaviour {
    ...
    public void shouldDescribeStepToReporterBeforeExecutingParametrisedStep() throws IntrospectionException {
        ...
        ((ParameterisedStep) stepCreator.createParametrisedStep(AnnotationProcessor.defaultAnnotationProcessor(), method, "When I run", "I run", null)).describeTo(storyReporter);
    ...
    public void shouldHandleTargetInvocationFailureInParametrisedStep() throws IntrospectionException {
        ...
        StepResult stepResult = stepCreator.createParametrisedStep(AnnotationProcessor.defaultAnnotationProcessor(), method, "When I fail", "I fail", null).perform(null);
	...
	private void assertThatParametrisedStepHasMarkedParsedParametersValues(String firstParameterValue,
        ...
        // When
        StepResult stepResult = stepCreator.createParametrisedStep(AnnotationProcessor.defaultAnnotationProcessor(), SomeSteps.methodFor("aMethodWithANamedParameter"),
    ...
    public void shouldMatchParametersByDelimitedNameWithNoNamedAnnotations() throws Exception {
        ...
        // When
        Step step = stepCreator.createParametrisedStep(AnnotationProcessor.defaultAnnotationProcessor(), SomeSteps.methodFor("aMethodWithoutNamedAnnotation"),
    ...
    public void shouldMatchParametersByDelimitedNameWithDistinctNamedAnnotations() throws Exception {
        ...
        // When
        Step step = stepCreator.createParametrisedStep(AnnotationProcessor.defaultAnnotationProcessor(), SomeSteps.methodFor("aMethodWithANamedParameter"),
