...
public class StepFinderBehaviour {
	...
	public void shouldFindStepdocs() throws Exception {
		...
		assertThatStepdocIs(stepdocs.get(1), "thenFoo", "thenFoo(java.lang.String)", "foo named $name", "Then", THEN, mySteps);
		assertThatStepdocIs(stepdocs.get(2), "whenFoo", "whenFoo(java.lang.String)", "foo named $name", "When", WHEN, mySteps);
	}
