...
public class EngineSpecification extends EngineType implements IEngineSpecification {

	private final IEngineStrategy engineStrategy;
	private final Object defaultOutput;

	public EngineSpecification(Class<?> resultClass, Class<?>[] parameters, IEngineStrategy engineStrategy, Object defaultOutput) {
