package org.autotdd.example.customerCategorisation

import scala.language.implicitConversions
import org.autotdd.engine.Engine
import org.junit.runner.RunWith
import org.autotdd.engine.tests._
import org.autotdd.example.processCheque_DM_1.GBP
...
object CategorisePerson {
  ...
  def main(args: Array[String]) {
    org.autotdd.example.WebServer.launch("org.autotdd.example.customerCategorisation")
